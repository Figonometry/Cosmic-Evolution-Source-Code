...
public final class ThreadRebuildChunk implements Runnable {
    ...
    public void rebuildChunk() {
        ...
        this.workingChunk.vertexArrayOpaque = new float[size * 40];
        this.workingChunk.vertexArrayTransparent = new float[size * 40];
        this.workingChunk.vertexBufferOpaque = BufferUtils.createFloatBuffer(size * 40);
        this.workingChunk.elementBufferOpaque = BufferUtils.createIntBuffer(size * 6);
        this.workingChunk.vertexBufferTransparent = BufferUtils.createFloatBuffer(size * 40);
        ...
        this.workingChunk.elementArrayOpaque = new int[(this.workingChunk.vertexArrayOpaque.length / 40) * 6];
        int elementOffset = 0;
        int index = 0;
        ...
        this.workingChunk.elementArrayTransparent = new int[(this.workingChunk.vertexArrayTransparent.length / 40) * 6];
        elementOffset = 0;
        index = 0;
