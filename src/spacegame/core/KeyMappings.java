...
public abstract class KeyMappings {
    ...
    public static String getKeyNameFromMap(){
        ...
        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_APOSTROPHE) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_APOSTROPHE)){
            return "'";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_COMMA) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_COMMA)){
            return ",";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_MINUS) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_MINUS)){
            return "-";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_PERIOD) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_PERIOD)){
            return ".";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_SLASH) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_SLASH)){
            return "/";
        }
        ...
        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_SEMICOLON) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_SEMICOLON)){
            return ";";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_EQUAL) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_EQUAL)){
            return "=";
        }
        ...
        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_LEFT_BRACKET) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_LEFT_BRACKET)){
            return "[";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_RIGHT_BRACKET) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_RIGHT_BRACKET)){
            return "]";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_GRAVE_ACCENT) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_GRAVE_ACCENT)){
            return "`";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_ENTER) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_ENTER)){
            return "Enter";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_TAB) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_TAB)){
            return "Tab";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_BACKSPACE) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_BACKSPACE)){
            return "Backspace";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_INSERT) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_INSERT)){
            return "Insert";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_DELETE) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_DELETE)){
            return "Delete";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_RIGHT) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_RIGHT)){
            return "Right";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_LEFT) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_LEFT)){
            return "Left";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_DOWN) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_DOWN)){
            return "Down";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_UP) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_UP)){
            return "Up";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_PAGE_UP) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_PAGE_UP)){
            return "Page Up";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_PAGE_DOWN) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_PAGE_DOWN)){
            return "Page Down";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_HOME) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_HOME)){
            return "Home";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_END) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_END)){
            return "End";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_CAPS_LOCK) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_CAPS_LOCK)){
            return "Caps Lock";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_SCROLL_LOCK) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_SCROLL_LOCK)){
            return "Scroll Lock";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_NUM_LOCK) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_NUM_LOCK)){
            return "Num Lock";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_PRINT_SCREEN) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_PRINT_SCREEN)){
            return "Print Screen";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_PAUSE) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_PAUSE)){
            return "Pause";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_F1) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_F1)){
            return "F1";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_F2) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_F2)){
            return "F2";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_F3) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_F3)){
            return "F3";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_F4) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_F4)){
            return "F4";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_F5) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_F5)){
            return "F5";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_F6) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_F6)){
            return "F6";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_F7) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_F7)){
            return "F7";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_F8) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_F8)){
            return "F8";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_F9) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_F9)){
            return "F9";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_F10) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_F10)){
            return "F10";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_F11) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_F11)){
            return "F11";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_F12) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_F12)){
            return "F12";
        }
        ...
        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_KP_DECIMAL) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_KP_DECIMAL)){
            return "Numpad .";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_KP_DIVIDE) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_KP_DIVIDE)){
            return "Numpad /";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_KP_MULTIPLY) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_KP_MULTIPLY)){
            return "Numpad *";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_KP_SUBTRACT) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_KP_SUBTRACT)){
            return "Numpad -";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_KP_ADD) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_KP_ADD)){
            return "Numpad +";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_KP_ENTER) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_KP_ENTER)){
            return "Numpad Enter";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_KP_EQUAL) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_KP_EQUAL)){
            return "Numpad Equal";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_LEFT_SHIFT) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_LEFT_SHIFT)){
            return "Left Shift";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_LEFT_CONTROL) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_LEFT_CONTROL)){
            return "Left Control";
        }

        if(KeyListener.isKeyPressed(GLFW.GLFW_KEY_LEFT_ALT) || KeyListener.isKeyPressed(GLFW.GLFW_KEY_LEFT_ALT)){
            return "Left Alt";
        }
        return null;
    }
