...
public final class GuiPauseInGame extends Gui {
    ...
    public void loadTextures() {
        this.title = CosmicEvolution.instance.renderEngine.createTexture("src/spacegame/assets/textures/gui/guiInGame/pause.png", RenderEngine.TEXTURE_TYPE_2D, 0, true);
