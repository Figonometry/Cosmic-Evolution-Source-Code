...
public abstract class Assets {
    ...
    public static void enableBlockTextureArray(){
        blockTextureArray = CosmicEvolution.instance.renderEngine.createTexture("src/spacegame/assets/textures/blocks/", RenderEngine.TEXTURE_TYPE_2D_ARRAY, 96, true); //One higher than the expected amount
    }
