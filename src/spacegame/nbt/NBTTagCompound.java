...
public final class NBTTagCompound extends NBTBase {
    ...
    public void setIntArray(String name, int[] value) {
        this.tagMap.put(name, new NBTTagIntArray(value).setKey(name));
    }
    public void setShortArray(String name, short[] value) {
        this.tagMap.put(name, new NBTTagShortArray(value).setKey(name));
    }
    ...
    public short[] getShortArray(String name) {
        return !this.tagMap.containsKey(name) ? new short[0] : ((NBTTagShortArray)this.tagMap.get(name)).shortArray;
    }

    public NBTTagCompound getCompoundTag(String name) {
        return !this.tagMap.containsKey(name) ? null : (NBTTagCompound)this.tagMap.get(name);
    }
