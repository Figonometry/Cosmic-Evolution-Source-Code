...
public final class EntityWolf extends EntityLiving implements IDecayable, IHarvestable {
    ...
    public void dropItems(double x, double y, double z, World world, EntityPlayer player) {
        ...
        item = new EntityItem(this.x + CosmicEvolution.globalRand.nextDouble(-0.5f, 0.5f), this.y, this.z + CosmicEvolution.globalRand.nextDouble(-0.5f, 0.5f), Item.wolfPelt.ID, Item.NULL_ITEM_METADATA, (byte) 1, Item.NULL_ITEM_DURABILITY, 0, null);
        item.yaw = CosmicEvolution.globalRand.nextFloat(360f);
        world.addEntity(item);
    ...
    public void saveToNBT(NBTTagCompound nbtTagCompound){
        nbtTagCompound.setString("entityType", "EntityWolf");
